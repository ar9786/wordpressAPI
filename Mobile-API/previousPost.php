...
if ($_SERVER['REQUEST_METHOD'] == GET && isset($_GET['user_id'])){
	...
	$adds[] = array("title"=>$heder_adds->text, "image"=>$img_url.$heder_adds->image,"event_url"=>'',"content"=>$heder_adds->content);
	}
	...
	*/
	...
	$top_posts = get_posts("meta_key=frontpage&meta_value=yes&numberposts=20");
	$i=0;
